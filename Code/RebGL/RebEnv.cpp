...
RebMatrix RebGLTerrain::GetTrans()
{
	return trans;
}
...
ITerrain * RebEnv::CreateTerrain(std::string hmf)
{
	ITerrain * ret = new RebGLTerrain();
...
std::vector<ITerrain*> * RebEnv::GetTerrains()
{
	return &Terrains;
}

void RebEnv::DeleteTerrain(ITerrain * del)
{
