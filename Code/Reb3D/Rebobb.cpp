...
// F U N C T I O N S ///////////////////////////////////////////////
 ...
 void RebObb::DeTransform(const RebObb &obb, const RebMatrix &m) {
   RebMatrix mat = m;
   RebVector vcT;
...
// helperfunction
void RebObb::TriProj(const RebVector &v0, const RebVector &v1, 
...
// intersects trianlge
bool RebObb::Intersects(const RebVector &v0, 
                        const RebVector &v1, 
                        const RebVector &v2) {
   float     fMin0, fMax0, fMin1, fMax1;
   float     fD_C;
   RebVector vcV, vcTriEdge[3], vcA[3];
...
bool RebObb::Intersects(const RebRay &Ray, float *t) {
